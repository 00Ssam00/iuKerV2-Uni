...
interface SearchBarMedicosProps {
  primaryColor: string;
...
const SearchBarMedicos: React.FC<SearchBarMedicosProps> = ({ primaryColor, onSearch, onNuevoMedico, initialValue = '' }) => {
      ...
      <form onSubmit={handleSubmit} className='flex-1'>
        <div className='relative'>
          ...
          <input
            ...
            placeholder='Buscar por nombre, especialidad o tarjeta...'
...
export default SearchBarMedicos;
